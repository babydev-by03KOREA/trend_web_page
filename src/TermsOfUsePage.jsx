            ...
            <div className="main-container">
                ...
                <div className="container-wrapper">
                    ...
                    <div className="description">
                        THIS APPLICATION ("THE SERVICE") COLLECTS NEAR REAL-TIME DATA FROM TRUSTED THIRD-PARTY
                        PROVIDERS,
                        ...
                        PERPLEXITY API. WHILE WE STRIVE FOR ACCURACY, COMPLETENESS, AND TIMELINESS, USERS SHOULD BE
                        AWARE
                        THAT DATA AND AI-BASED INSIGHTS MAY VARY SLIGHTLY FROM OTHER SOURCES DUE TO DIFFERENCES IN DATA
                        PROVIDERS, ALGORITHMIC CALCULATIONS, AND MARKET CONDITIONS. TECHNICAL ISSUES, NETWORK
                        INTERRUPTIONS,
                        OR LIMITATIONS OF THIRD-PARTY PROVIDERS MAY RESULT IN TEMPORARY DELAYS OR INCONSISTENCIES, AND
                        THE
                    ...
                    <div className="description">
                        ...
                        STOCK) BASED ON INFORMATION AND DATA COLLECTED OVER THE LAST WEEK. THIS ANALYSIS INCLUDES
                        AI-BASED
                        KEY POINT INSIGHTS, INDIVIDUAL ASSET MARKET SENTIMENT EVALUATIONS, AND EXAMINATIONS OF RECENT
                        MARKET
                        DEVELOPMENTS.
                        MARKET SENTIMENT ANALYSIS OFFERS AN AI-BASED EVALUATION OF OVERALL MARKET SENTIMENT, INDICATING
                        WHETHER CURRENT CONDITIONS ARE CHARACTERIZED BY EXTREME FEAR, FEAR, GREED, OR EXTREME GREED.
                        THIS
                        INSIGHT IS GENERATED USING DATA FROM MULTIPLE TRUSTED SOURCES AND IS INTENDED TO PROVIDE A
                        GENERAL
                        ...
                        TRENDS OVER SPECIFIED TIMEFRAMES. THIS ANALYSIS IS BASED ON NEAR REAL-TIME DATA AND IS DESIGNED
                        TO
                        HELP USERS UNDERSTAND THE ASSET'S TECHNICAL PERFORMANCE.
                        ALL ANALYSES ARE GENERATED VIA THE PERPLEXITY API USING DATA COLLECTED FROM VARIOUS TRUSTED
                        SOURCES.
                        WHILE EVERY EFFORT IS MADE TO ENSURE THE ACCURACY OF THESE ANALYSES, LIMITATIONS IN AI
                        ALGORITHMS OR
                    ...
                    <div className="description">
                        ...
                        NOTICE. WE RESERVE THE RIGHT TO DISCONTINUE OR LIMIT THE SERVICE AT ANY TIME, WITH NO LIABILITY
                        FOR
                    ...
                    <SizedBox height={"32px"}/>
                    <div className="description">
                        USERS MAY CANCEL A PAID SUBSCRIPTION AT ANY TIME. ALL FEES PAID ARE NON-REFUNDABLE.
                        CANCELLATIONS
                        WILL TAKE EFFECT AT THE BEGINNING OF THE NEXT BILLING CYCLE, WHILE USERS CONTINUE TO HAVE ACCESS
                        THROUGH THE CURRENT PAID PERIOD. IF THE SERVICE BECOMES INOPERABLE DUE TO ISSUES ATTRIBUTABLE TO
                        THE
                    ...
                    <SizedBox height={"32px"}/>
                    <div className="description">
                        ALL DATA, ANALYSIS, AND AI-BASED INSIGHTS PROVIDED BY THIS SERVICE ARE FOR REFERENCE PURPOSES
                        ONLY
                        AND DO NOT CONSTITUTE INVESTMENT ADVICE, FINANCIAL GUIDANCE, OR A SOLICITATION TO BUY OR SELL
                        ASSETS. USERS ACKNOWLEDGE THAT ALL INVESTMENT DECISIONS ARE MADE AT THEIR OWN RISK, AND THAT
                        PAST
                        PERFORMANCE OR ANALYTICAL INSIGHTS DO NOT GUARANTEE FUTURE RESULTS. THIS SERVICE DOES NOT ACT AS
                        A
                        BROKER, EXCHANGE, OR FINANCIAL INTERMEDIARY, NOR DOES IT EXECUTE TRADES OR HOLD FUNDS ON BEHALF
                        OF
