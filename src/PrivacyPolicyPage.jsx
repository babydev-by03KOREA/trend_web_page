        ...
        <>
            ...
            <div className="main-container">
                ...
                <div className="description">
                    ...
                    LOGIN INFORMATION (E.G., APP STORE ID, GOOGLE PLAY ID) REQUIRED TO PROVIDE THE SERVICE. USERS MAY
                ...
                <SizedBox height={"32px"}/>
                <div className="description">
                    PERSONAL INFORMATION IS RETAINED ONLY FOR THE PERIOD NECESSARY TO FULFILL THE PURPOSES FOR WHICH IT
                ...
                <div className="description">
                    ...
                    STORAGE, ACCESS CONTROLS TO RESTRICT AND MINIMIZE ACCESS TO SENSITIVE INFORMATION, AND REGULAR USE
                ...
                <SizedBox height={"32px"}/>
                <div className="description">
                    USERS MAY REQUEST ACCESS TO, MODIFICATION OF, OR DELETION OF THEIR PERSONAL INFORMATION AT ANY TIME.
                    THEY MAY ALSO WITHDRAW CONSENT FOR THE PROCESSING OF THEIR PERSONAL INFORMATION. ALL REQUESTS WILL
                ...
                <SizedBox height={"32px"}/>
                <div className="description">
                    USERS WILL BE NOTIFIED OF ANY CHANGES TO THIS POLICY. MINOR CHANGES WILL BE COMMUNICATED AT LEAST
                    SEVEN DAYS IN ADVANCE, WHILE SIGNIFICANT CHANGES WILL BE COMMUNICATED AT LEAST 30 DAYS IN ADVANCE.
                </div>
